...
namespace CSharp.App
{
    public static class Program
    {
        ...
        //Invoice Date Method for Unit Tets
        #region Unit Test Methods:
        public static (DateTime FirstDayOfMonth, DateTime LastDayOfMonth) InvoiceDateTest(this DateTime now)
        {
        ...
        //Invoice Due Date Method for Unit Test
        public static (DateTime FirstDayOfMonth, DateTime LastDayOfMonth) InvoiceDueDateTest(this DateTime now)
        {
            var startDate = new DateTime(now.Year, now.Month, 1);
